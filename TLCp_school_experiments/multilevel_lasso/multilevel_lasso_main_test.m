 % function[explained_variance]=multilevel_lasso_main_test(num_train_1)
 clear
% tic
 num_train_1=170;
num_test_1=30;
...
data_train_2=data_X.X{1,20};

Y_train_1=data_Y.Y{1,1};
Y_train_2=data_Y.Y{1,20};
...
beta0=0;%mean(Y_train_1-data1*beta1);
trained_beta_hat_T1=beta1;
%% error calculation
