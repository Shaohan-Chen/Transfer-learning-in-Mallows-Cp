%function [explained_variance]=aggregate_stepwise(num_train_1)
clear;
tic
num_train_1=290;
num_test_1=100;
...
% feature selection
 ...
 [b,se,pval,inmodel,stats,nextstep,history] = stepwisefit(X_train,Y_train,'PRemove',0.05,'Display','off');
