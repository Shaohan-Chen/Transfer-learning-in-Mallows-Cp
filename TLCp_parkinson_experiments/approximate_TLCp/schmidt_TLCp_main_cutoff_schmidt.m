...
[trained_beta_source,v2]=Cp_transfer_source_solution(data_schmidt1,Y_train_1,data_schmidt2,Y_train_2,lambda_1,lambda_2,lambda_3,lambda_4,num_train_1,num_train_2,size(data_schmidt1,2));
